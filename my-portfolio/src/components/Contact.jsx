  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "shivshankar yadav",
          from_email: form.email,
          to_email: "info.shivshankar2002@gmail.com",
      ...
      >
        ...
        <div className="mt-5 contact__options">
          <article className="contact__option">
            <MdEmail />
            <a href="mailto:info.shivshankar2002@gmail.com" target="_blank" className="blue-text-gradient">info.shivshankar2002@gmail.com</a>
          </article>
          <article className="contact__option">
            <BsWhatsapp />
