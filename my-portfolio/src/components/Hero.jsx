...
const Hero = () => {
  ...
  useEffect(() => {
    init(textRef.current, { showCursor: true, strings: [' SDE at Bluestock Fintech ', ' SDE at Border Wallet ', 'Software Developer ', " Tech Enthusiast "] })
  }, []);
        ...
        >
          ...
          <div className="head2">
            <h1 className={`${styles.heroHeadText} text-white`}>
              Hii there, I'm <p className='name text-[#915EFF]'>Shivshankar Yadav</p>
            </h1>
            <h3>
            ...
            <div className="absolute link1">
              <a
                href="https://github.com/shivshankar001" target="_blank">
                <AiOutlineGithub />
              </a>
              <a
                href="https://www.linkedin.com/in/shivshankar-yadav-576b00236/" target="_blank">
                <ImLinkedin />
              </a>
              <a
                href="" target="_blank">
